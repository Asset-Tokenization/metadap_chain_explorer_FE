...
const VerifiedAddresses = () => {
  ...
  if (selectedAddress) {
    ...
    return (
      <>
        <PageTitle title="Certificate info application form" backLink={backLink} />
        <TokenInfoForm
  ...
  return (
    <>
      ...
      <AccountPageDescription allowCut={false}>
        <span>
          Verify ownership of a smart contract address to easily update information in Blockscout. You will sign a single message to verify contract ownership.
          Once verified, you can update token information, address name tags, and address labels from the Blockscout console without needing to sign additional
          messages.
        </span>
