...
base('base view +@mobile +@dark-mode', async ({ mount, page }) => {
  ...
  const filteredTokens = {
    items: [tokens.tokenInfoERC20a, tokens.tokenInfoERC20b, tokens.tokenInfoERC20c],
  ...
  await component.getByRole('textbox', { name: 'Certificate name or symbol' }).focus();
  await component.getByRole('textbox', { name: 'Certificate name or symbol' }).type('foo');
