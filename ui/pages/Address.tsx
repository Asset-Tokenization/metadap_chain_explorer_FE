...
const AddressPageContent = () => {
  ...
  const tags = (
    <EntityTags
      ...
      tagsBefore={[
        ...
        addressQuery.data?.token ? { label: 'certificate', display_name: 'Certificate' } : undefined,
  ...
  const titleSecondRow = (
    <Flex alignItems="center" w="100%" columnGap={2} rowGap={2} flexWrap={{ base: 'wrap', lg: 'nowrap' }}>
      ...
      />
      {!isLoading && addressQuery.data?.is_contract && addressQuery.data.token && <AddressAddToWallet token={addressQuery.data.token} variant="button" />}
