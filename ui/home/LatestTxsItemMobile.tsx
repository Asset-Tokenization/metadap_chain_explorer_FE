  ...
  return (
    ...
    >
      ...
      <Flex mt={2} alignItems="center" width="100%" justifyContent="space-between" mb={6}>
        <TxEntity isLoading={isLoading} hash={tx.hash} fontWeight="700" truncation="constant" />
        {tx.timestamp && (
      ...
      <Flex alignItems="center" mb={3}>
        <AddressEntity isLoading={isLoading} address={tx.from} truncation="constant" fontSize="sm" fontWeight="500" mr={2} />
        <Icon as={rightArrowIcon} boxSize={6} color="gray.500" isLoading={isLoading} />
        {dataTo && <AddressEntity isLoading={isLoading} address={dataTo} truncation="constant" fontSize="sm" fontWeight="500" />}
      </Flex>
