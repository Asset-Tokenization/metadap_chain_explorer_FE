...
const ContractVerificationFieldAutodetectArgs = () => {
  ...
  const renderControl = React.useCallback(
    ({ field }: { field: ControllerRenderProps<FormFields, 'autodetect_constructor_args'> }) => (
  ...
  return (
    <>
      <ContractVerificationFormRow>
        <Controller name="autodetect_constructor_args" control={control} render={renderControl} />
      </ContractVerificationFormRow>
