...
const ContractVerificationVyperMultiPartFile = () => {
  const interfacesHint = (
    <>
      <span>Add any </span>
      <Link href="https://docs.vyperlang.org/en/stable/interfaces.html" target="_blank">
        required interfaces
      </Link>
  ...
  return (
    <ContractVerificationMethod title="Contract verification via Vyper (multi-part files)">
      ...
      <ContractVerificationFieldSources
        ...
        required
      />
      <ContractVerificationFieldSources name="interfaces" fileTypes={INTERFACE_TYPES} multiple title="Interfaces (.vy or .json)" hint={interfacesHint} />
