    ...
    <Tr alignItems="top">
      <Td verticalAlign="middle">
        <Flex rowGap={3} flexWrap="wrap">
          <TxEntity hash={txnHash} isLoading={isLoading} fontWeight={700} noIcon />
          {timestamp && (
      ...
      <Td verticalAlign="middle">
        <BlockEntity isLoading={isLoading} number={block} noIcon fontSize="sm" lineHeight={5} fontWeight={500} />
      </Td>
      <Td verticalAlign="middle">
        <AddressEntity address={from} isLoading={isLoading} noLink={isOut} noCopy={isOut} />
      </Td>
      ...
      <Td verticalAlign="middle">{toData && <AddressEntity address={toData} isLoading={isLoading} noLink={isIn} noCopy={isIn} />}</Td>
