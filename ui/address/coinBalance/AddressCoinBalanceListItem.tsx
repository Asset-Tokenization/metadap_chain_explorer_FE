  ...
  return (
    <ListItemMobile rowGap={2} isAnimated>
      ...
      <Flex columnGap={2} w="100%">
        ...
        <BlockEntity isLoading={props.isLoading} number={props.block_number} noIcon fontWeight={700} />
      </Flex>
      {props.transaction_hash && (
        <Flex columnGap={2} w="100%">
          ...
          <TxEntity hash={props.transaction_hash} isLoading={props.isLoading} noIcon fontWeight={700} maxW="150px" />
        </Flex>
      )}
      <Flex columnGap={2} w="100%">
        <Skeleton isLoaded={!props.isLoading} fontWeight={500} flexShrink={0}>
