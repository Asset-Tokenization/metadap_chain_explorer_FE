...
const tokenBalanceItemIdentityFactory = (match: AddressTokenBalance) => (item: AddressTokenBalance) =>
  match.token.address === item.token.address && match.token_id === item.token_id && match.token_instance?.id === item.token_instance?.id;
...
const AddressTokens = () => {
  ...
  const handleTokenBalancesErc20Message: SocketMessage.AddressTokenBalancesErc20['handler'] = React.useCallback(
    (payload) => {
  ...
  const handleTokenBalancesErc721Message: SocketMessage.AddressTokenBalancesErc721['handler'] = React.useCallback(
    (payload) => {
  ...
  const handleTokenBalancesErc1155Message: SocketMessage.AddressTokenBalancesErc1155['handler'] = React.useCallback(
    (payload) => {
  ...
  const tabs = [
    {
      id: tokenTabsByType['ERC-20'],
      title: 'MRC-20',
      component: <ERC20Tokens tokensQuery={erc20Query} />,
    },
    {
      id: tokenTabsByType['ERC-721'],
      title: 'MRC-721',
      component: <ERC721Tokens tokensQuery={erc721Query} />,
    },
    {
      id: tokenTabsByType['ERC-1155'],
      title: 'MRC-1155',
      component: <ERC1155Tokens tokensQuery={erc1155Query} />,
    },
  ];
