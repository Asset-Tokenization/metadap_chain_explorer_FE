    ...
    case 'swap': {
      ...
      return (
        <Flex flexWrap="wrap" columnGap={2} rowGap={2} alignItems="center" fontWeight={500}>
          ...
          <TokenEntity token={token0} noLink={data.symbol0 === 'Ether'} noCopy noIcon noSymbol w="auto" maxW="200px" flexShrink={0} />

          <chakra.span color="text_secondary">{type === 'swap' ? 'for' : 'and'}</chakra.span>

          <span>{amount1}</span>

          <TokenEntity token={token1} noLink={data.symbol1 === 'Ether'} noIcon noCopy noSymbol w="auto" maxW="200px" flexShrink={0} />
      ...
      return (
        <div>
          <Flex rowGap={2} columnGap={2} flexWrap="wrap" alignItems="center" whiteSpace="pre-wrap" fontWeight={500}>
            ...
            <AddressEntity address={{ hash: data.to }} truncation="constant" noIcon noCopy />
          </Flex>
