...
const BlocksContent = ({ type, query }: Props) => {
    ...
    <>
      <Box display={{ base: 'block', lg: 'none' }}>
        {query.pagination.page === 1 && (
          <SocketNewItemsNotice.Mobile url={window.location.href} num={newItemsCount} alert={socketAlert} type="block" isLoading={query.isPlaceholderData} />
        )}
  ...
  return <DataListDisplay isError={query.isError} items={query.data?.items} emptyText="There are no blocks." content={content} actionBar={actionBar} />;
};
