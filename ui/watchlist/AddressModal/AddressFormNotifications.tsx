...
const NOTIFICATIONS_NAMES = [config.chain.currency.symbol, 'MRC-20', 'MRC-721, MRC-1155 (NFT)'];
      ...
      {NOTIFICATIONS.map((notification: string, index: number) => {
        ...
        return (
          <React.Fragment key={notification}>
            ...
            <GridItem>
              <Controller name={incomingFieldName} control={control} render={renderCheckbox('Incoming')} />
            </GridItem>
            <GridItem>
              <Controller name={outgoingFieldName} control={control} render={renderCheckbox('Outgoing')} />
            </GridItem>
          </React.Fragment>
        );
      })}
