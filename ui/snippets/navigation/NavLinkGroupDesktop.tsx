import { Icon, Text, HStack, Box, Link, Popover, PopoverTrigger, PopoverContent, PopoverBody, VStack } from '@chakra-ui/react';
                ...
                Array.isArray(subItem) ? (
                  ...
                  >
                    {subItem.map((subSubItem) => (
                      <NavLink key={subSubItem.text} item={subSubItem} isCollapsed={false} />
                    ))}
                  </Box>
                ) : (
