...
const TokenInfoFieldRequesterName = ({ control, isReadOnly }: Props) => {
  const renderControl: ControllerProps<Fields, 'requester_name'>['render'] = React.useCallback(
  ...
  return <Controller name="requester_name" control={control} render={renderControl} rules={{ required: true }} />;
};
