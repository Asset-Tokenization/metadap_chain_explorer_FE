            ...
            <AccordionItem key={index} {...itemProps}>
              {({ isExpanded }) => (
                <>
                  ...
                  >
                    <Box className="codicon codicon-tree-item-expanded" transform={isExpanded ? 'rotate(0deg)' : 'rotate(-90deg)'} boxSize="16px" mr="2px" />
        ...
        return (
          ...
          >
            {mainFile === leaf.file_path && (
              <CodeEditorMainFileIndicator position="absolute" top={`${(22 - 12) / 2}px`} left={`${26 - 12 - 2 + level * 8}px`} />
            )}
