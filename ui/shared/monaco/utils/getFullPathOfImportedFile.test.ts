...
it('construct correct absolute path', () => {
  const result = getFullPathOfImportedFile('/foo/bar/baz/index.sol', './.././../abc/contract.sol');
...
describe('correctly manages remappings', () => {
  it('without context', () => {
    const result = getFullPathOfImportedFile('/index.sol', '@openzeppelin/contracts/access/AccessControl.sol', [
  ...
  it('with empty context', () => {
    const result = getFullPathOfImportedFile('./index.sol', '@base58-solidity/Base58.sol', [
      '@openzeppelin/=node_modules/@openzeppelin/',
  ...
  it('with non-empty context for file inside context directory', () => {
    const result = getFullPathOfImportedFile('/module_1/index.sol', '@base58-solidity/Base58.sol', [
      '@openzeppelin/=node_modules/@openzeppelin/',
  ...
  it('with non-empty context for file outside context directory', () => {
    const result = getFullPathOfImportedFile('/module_2/index.sol', '@base58-solidity/Base58.sol', [
      '@openzeppelin/=node_modules/@openzeppelin/',
      'module_1:@base58-solidity/=lib/base58-solidity/contracts/',
    ]);
