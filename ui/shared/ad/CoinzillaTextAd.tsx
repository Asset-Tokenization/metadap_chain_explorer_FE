...
const CoinzillaTextAd = ({ className }: { className?: string }) => {
  ...
  if (isLoading) {
    return <Skeleton className={className} h={{ base: 12, lg: 6 }} w="100%" flexGrow={1} maxW="800px" display="block" />;
  }
  ...
  return (
    <Box className={className}>
      <Text as="span" whiteSpace="pre-wrap" fontWeight={700} mr={3} display={{ base: 'none', lg: 'inline' }}>
        Ads:
      </Text>
