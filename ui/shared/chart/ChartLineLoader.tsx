...
const ChartLineLoader = ({ className }: { className?: string }) => {
  ...
  return (
    <svg className={className} width="100%" viewBox="0 0 707 272" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path d={d} stroke={lineBgColor} strokeWidth="4" strokeLinecap="round" fill="none" />
      <path ref={ref} d={d} stroke={lineFgColor} strokeWidth="4" strokeLinecap="round" strokeDasharray="10000,100000" strokeDashoffset="-10000" fill="none" />
    </svg>
  );
};
