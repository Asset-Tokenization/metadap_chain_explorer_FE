...
export type ItemsCategoriesMap = Record<ApiCategory, Array<SearchResultItem>> & Record<'app', Array<MarketplaceAppOverview>>;
...
export const searchCategories: Array<{ id: Category; title: string }> = [
  { id: 'app', title: 'Apps' },
  { id: 'token', title: 'Certificates (MRC-20)' },
  { id: 'nft', title: 'NFTs (MRC-721 & 1155)' },
...
export const searchItemTitles: Record<Category, { itemTitle: string; itemTitleShort: string }> = {
  ...
  token: { itemTitle: 'Certificate', itemTitleShort: 'Certificate' },
