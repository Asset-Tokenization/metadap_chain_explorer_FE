import { ChakraProvider as ChakraProviderDefault, cookieStorageManagerSSR, localStorageManager } from '@chakra-ui/react';
...
export function ChakraProvider({ cookies, theme, children }: Props) {
  const colorModeManager =
    typeof cookies === 'string' ? cookieStorageManagerSSR(typeof document !== 'undefined' ? document.cookie : cookies) : localStorageManager;
