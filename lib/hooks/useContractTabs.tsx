...
export default function useContractTabs(data: Address | undefined) {
  return React.useMemo(() => {
    return [
      ...
      //   undefined,
      data?.has_methods_read ? { id: 'read_contract', title: 'Read contract', component: <ContractRead addressHash={data?.hash} /> } : undefined,
      data?.has_methods_read_proxy ? { id: 'read_proxy', title: 'Read proxy', component: <ContractRead addressHash={data?.hash} isProxy /> } : undefined,
      data?.has_custom_methods_read
        ...
        : undefined,
      data?.has_methods_write ? { id: 'write_contract', title: 'Write contract', component: <ContractWrite addressHash={data?.hash} /> } : undefined,
      data?.has_methods_write_proxy ? { id: 'write_proxy', title: 'Write proxy', component: <ContractWrite addressHash={data?.hash} isProxy /> } : undefined,
