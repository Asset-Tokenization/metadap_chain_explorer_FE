...
type ResourcePathParamName<Resource extends ResourceName> = (typeof RESOURCES)[Resource] extends { pathParams: Array<string> }
...
/* eslint-disable @typescript-eslint/indent */
export type PaginationSorting<Q extends PaginatedResources> = Q extends 'tokens' ? TokensSorting : Q extends 'tokens_bridged' ? TokensSorting : never;
/* eslint-enable @typescript-eslint/indent */
