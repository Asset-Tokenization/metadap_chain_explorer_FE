...
export const apps = [
  ...
  },
  {
    ...
    title: "Certificate Approval Tracker",
    logo: "https://approval-tracker.apps.blockscout.com/icon-192.png",
    categories: ["Infra & Dev tooling"],
    shortDescription:
      "Asset Approval Tracker shows all approvals for any ERC20-compliant certificates and NFTs and lets to revoke them or adjust the approved amount.",
